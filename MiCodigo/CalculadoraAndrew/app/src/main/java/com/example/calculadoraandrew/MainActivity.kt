package com.example.calculadoraandrew
...
class MainActivity : AppCompatActivity() {
    //Creacion de variables de las operaciones
    val SUMA = "+"
    val RESTA = "-"
    val MULTIPLICACION = "*"
    val DIVISION = "/"
    ...
    var operacionActual = ""
    //Creacion de variables para los numeros de tipo Double inicializados en Nada(Vacio)
    var primerNumero:Double = Double.NaN
    var segundoNumero:Double = Double.NaN
    //Creacion de variables que se van a inicializar despues de tipo TextView
    lateinit var tvTemp:TextView
    lateinit var tvResult:TextView
    //Creacion de una variable para el formato decimal
    ...
    fun cambiarOperador(b:View){
        if (tvTemp.text.isNotEmpty() || primerNumero.toString() != "NaN"){
            calcular()
            //Conviertiendo View b en un boton
            val boton:Button = b as Button
            //.trim() es para evitar espacios en blanco
